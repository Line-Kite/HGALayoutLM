            ...
            features=datasets.Features(
                {
                    ...
                    "ner_tags": datasets.Sequence(
                        datasets.features.ClassLabel(
                            names=['B-MENU.CNT', 'I-MENU.CNT', 'B-MENU.DISCOUNTPRICE', 'I-MENU.DISCOUNTPRICE', 'B-MENU.ETC', 'I-MENU.ETC', 'B-MENU.ITEMSUBTOTAL', 'I-MENU.ITEMSUBTOTAL', 'B-MENU.NM', 'I-MENU.NM', 'B-MENU.NUM', 'I-MENU.NUM', 'B-MENU.PRICE', 'I-MENU.PRICE', 'B-MENU.SUB_CNT', 'I-MENU.SUB_CNT', 'B-MENU.SUB_ETC', 'I-MENU.SUB_ETC', 'B-MENU.SUB_NM', 'I-MENU.SUB_NM', 'B-MENU.SUB_PRICE', 'I-MENU.SUB_PRICE', 'B-MENU.SUB_UNITPRICE', 'I-MENU.SUB_UNITPRICE', 'B-MENU.UNITPRICE', 'I-MENU.UNITPRICE', 'B-MENU.VATYN', 'I-MENU.VATYN', 'B-SUB_TOTAL.DISCOUNT_PRICE', 'I-SUB_TOTAL.DISCOUNT_PRICE', 'B-SUB_TOTAL.ETC', 'I-SUB_TOTAL.ETC', 'B-SUB_TOTAL.OTHERSVC_PRICE', 'I-SUB_TOTAL.OTHERSVC_PRICE', 'B-SUB_TOTAL.SERVICE_PRICE', 'I-SUB_TOTAL.SERVICE_PRICE', 'B-SUB_TOTAL.SUBTOTAL_PRICE', 'I-SUB_TOTAL.SUBTOTAL_PRICE', 'B-SUB_TOTAL.TAX_PRICE', 'I-SUB_TOTAL.TAX_PRICE', 'B-TOTAL.CASHPRICE', 'I-TOTAL.CASHPRICE', 'B-TOTAL.CHANGEPRICE', 'I-TOTAL.CHANGEPRICE', 'B-TOTAL.CREDITCARDPRICE', 'I-TOTAL.CREDITCARDPRICE', 'B-TOTAL.EMONEYPRICE', 'I-TOTAL.EMONEYPRICE', 'B-TOTAL.MENUQTY_CNT', 'I-TOTAL.MENUQTY_CNT', 'B-TOTAL.MENUTYPE_CNT', 'I-TOTAL.MENUTYPE_CNT', 'B-TOTAL.TOTAL_ETC', 'I-TOTAL.TOTAL_ETC', 'B-TOTAL.TOTAL_PRICE', 'I-TOTAL.TOTAL_PRICE', 'B-VOID_MENU.NM', 'I-VOID_MENU.NM', 'B-VOID_MENU.PRICE', 'I-VOID_MENU.PRICE', 'O']
                        )
                    ),
